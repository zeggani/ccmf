...
<form method="post" id="form" action="{{route('setStep')}}">
@csrf
<input type="hidden" name="client" value="{{$client->id_clients}}">
<input type="hidden" name="step" value="{{Auth::user()->role->name}}">
<button class="btn" style="background:#38c172;color:white;" type="submit">Sup</button>
</form>
